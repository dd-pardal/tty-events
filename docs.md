...
* [tty-input](#module_tty-input)
    * [Terminal](#exp_module_tty-input--Terminal) ⏏
        ...
        * _instance_
            ...
            * [.enableFocus()](#module_tty-input--Terminal+enableFocus)
            * [.disableFocus()](#module_tty-input--Terminal+disableFocus)
...
**Kind**: instance method of [<code>Terminal</code>](#exp_module_tty-input--Terminal)  
<a name="module_tty-input--Terminal+enableFocus"></a>

#### terminal.enableFocus()
Enables focus events.

**Kind**: instance method of [<code>Terminal</code>](#exp_module_tty-input--Terminal)  
<a name="module_tty-input--Terminal+disableFocus"></a>
...
**Kind**: static class of [<code>Terminal</code>](#exp_module_tty-input--Terminal)  
...
**Kind**: static property of [<code>Terminal</code>](#exp_module_tty-input--Terminal)  
